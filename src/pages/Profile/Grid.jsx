  ...
  return (
    <div className={`flex flex-wrap ${className} `}>
      {dummyData?.map((item, index) => (
        ...
        >
          {/* Image */}
          <div className="h-260 w-30%" onClick={() => onDetail({ art: item })}>
          ...
          <div>
            ...
            >
              <div className="py-2 w-full">
                <button className="  w-full bg-white hover:bg-primary text-black font-semibold hover:text-white py-2  border border-black hover:border-primary">
                  ENQUIRE
                </button>
              </div>
              <div className="  py-2 w-full">
