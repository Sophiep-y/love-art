...
const ProfilePage = () => {
  ...
  return (
    <AnimationLayout>
      ...
      >
        <div
          className={`${isMobile ? "block" : "flex"} justify-between items-center pt-5 px-5`}
        >
          <div className="flex justify-between items-center">
            <span className="text-6xl text-black uppercase">Profile</span>
            {isMobile && (
              <Sidebar
                icon={<CrossIcon className="h-8" />}
                fromSidebarNav={true}
              />
            )}
          </div>
          <div
            className={`flex justify-between ${isMobile ? "mt-2 w-full" : "w-3/5"}`}
          >
            {
              <div
            ...
            {isMobile && (
              <div className="flex justify-between">
                ...
                >
                  <DropdownOption>Collection</DropdownOption>

                  <DropdownOption>Wishlist</DropdownOption>
                </Dropdown>
            ...
            <div
              className={`flex ${isMobile ? " justify-end" : ""} cursor-pointer  min-w-32`}
              onClick={() => {
        ...
        >
          ...
          <div className={`${isMobile ? "w-max" : "w-3/5"}`}>
            ...
            <Grid
              ...
              isWishList={selectedCategory === "Wishlist"}
