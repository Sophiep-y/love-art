...
const Title = ({title, position}) => {
    const positionStyle = (position === Position.Top) ? 'hidden lg:inline-block md:inline-block ' : 'sm:hidden flex justify-center mx-auto absolute bottom-4 left-4 right-4';
